            ...
            <div class="row">
                <div class="col-sm-12">
                    <!-- Authentication card start -->
                        ...
                        <form class="md-float-material form-material" action="{{ route('postAdminLogin') }}" method="POST">
                            @csrf
                            @if (session('fail'))
                            <div class="col-form-label">{{ Session::get('fail') }}
                            </div>
                            @endif
                            <div class="auth-box card">
                                <div class="card-block">
                                    ...
                                    <div class="form-group form-primary">
                                        ...
                                        @if ($errors->has('email'))
                                        <div class="col-form-label">{{ $errors->first('email') }}
                                        </div>
                                        @endif
                                    </div>
                                    <div class="form-group form-primary">
                                        ...
                                        <div class="col-form-label">{{ $errors->first('password') }}
                                        </div>
                                        @endif
                                    </div>
